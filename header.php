...
<?php
$theme_sun_icon = tailpress_get_theme_asset('assets/images/icon-sun.svg');
$theme_moon_icon = tailpress_get_theme_asset('assets/images/icon-moon.svg');
?>
			...
			<div class="flex items-center gap-3">
				...
				<button type="button" class="theme-toggle hidden lg:inline-flex cursor-pointer" data-theme-toggle aria-pressed="false">
					...
					<span class="theme-toggle-icon" aria-hidden="true">
						<?php if ($theme_sun_icon !== null) : ?>
							<img src="<?php echo esc_url($theme_sun_icon['uri']); ?>" alt="" class="theme-icon-sun" width="28" height="28">
						<?php endif; ?>
						<?php if ($theme_moon_icon !== null) : ?>
							<img src="<?php echo esc_url($theme_moon_icon['uri']); ?>" alt="" class="theme-icon-moon" width="28" height="28">
						<?php endif; ?>
					</span>
				</button>
			</div>
